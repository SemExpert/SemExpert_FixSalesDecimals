...
class ItemTest extends TestCase
{
    ...
    public function getItemQtyVariants()
    {
        return [
            'empty_item' => [
                'options' => [
                    'qty_ordered' => 0.0, 'qty_invoiced' => 0.0, 'qty_refunded' => 0.0, 'qty_shipped' => 0.0,
                    'qty_canceled' => 0.0
                ],
            ...
            'ordered_item' => [
                'options' => [
                    'qty_ordered' => 12.0, 'qty_invoiced' => 0.0, 'qty_refunded' => 0.0, 'qty_shipped' => 0.0,
                    'qty_canceled' => 0.0
                ],
            ...
            'partially_invoiced' => [
                'options' => [
                    'qty_ordered' => 12.0, 'qty_invoiced' => 4.0, 'qty_refunded' => 0.0, 'qty_shipped' => 0.0,
                    'qty_canceled' => 0.0
                ],
            ...
            'partially_invoiced_refunded' => [
                'options' => [
                    'qty_ordered' => 12.0, 'qty_invoiced' => 5.0, 'qty_refunded' => 5.0, 'qty_shipped' => 0.0,
                    'qty_canceled' => 0.0,
                ],
            ...
            'partially_refunded' => [
                'options' => [
                    'qty_ordered' => 12.0, 'qty_invoiced' => 12.0, 'qty_refunded' => 5.0, 'qty_shipped' => 0.0,
                    'qty_canceled' => 0.0,
                ],
            ...
            'partially_shipped' => [
                'options' => [
                    'qty_ordered' => 12.0, 'qty_invoiced' => 0.0, 'qty_refunded' => 0.0, 'qty_shipped' => 4.0,
                    'qty_canceled' => 0.0
                ],
            ...
            'partially_refunded_partially_shipped' => [
                'options' => [
                    'qty_ordered' => 12.0, 'qty_invoiced' => 12.0, 'qty_refunded' => 5.0, 'qty_shipped' => 4.0,
                    'qty_canceled' => 0.0
                ],
            ...
            'complete' => [
                'options' => [
                    'qty_ordered' => 12.0, 'qty_invoiced' => 12.0, 'qty_refunded' => 0.0, 'qty_shipped' => 12.0,
                    'qty_canceled' => 0.0
                ],
                'expectedResult' => ['to_ship' => 0.0, 'to_invoice' => 0.0]
            ],
            ...
            'completely_shipped_using_decimals' => [
                'options' => [
                    'qty_ordered' => 4.4, 'qty_invoiced' => 0.4, 'qty_refunded' => 0.4, 'qty_shipped' => 4.0,
                    'qty_canceled' => 0.0,
                ],
            ...
            'completely_invoiced_using_decimals' => [
                'options' => [
                    'qty_ordered' => 4.4, 'qty_invoiced' => 4.0, 'qty_refunded' => 0.0, 'qty_shipped' => 4.0,
                    'qty_canceled' => 0.4
                ],
                'expectedResult' => ['to_ship' => 0.0, 'to_invoice' => 0.0]
            ]
